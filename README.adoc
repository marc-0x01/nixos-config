...
<div style="text-align: center"  align="center">
  ...
  <a href="https://github.com/marc-0x01/nixos-config/blob/master/LICENSE.txt"><img src="https://img.shields.io/github/license/marc-0x01/nixos-config.svg?style=for-the-badge" alt="https://img.shields.io/github/license/marc-0x01/nixos-config"></a>
  <!-- Main Technologies -->
