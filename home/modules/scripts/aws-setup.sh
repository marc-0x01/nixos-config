...
# Modified 2023 Marc Guillen for personnal use
#

#
# Syntax:
#
# aws-setup <region> <start_url> [<profile_file>]
#
...
echo "" >> "$profilefile"
echo "###" >> "$profilefile"
echo "### Autogenerated by aws-setup.sh" >> "$profilefile"
echo "###" >> "$profilefile"
...
echo >> "$profilefile"
echo "###" >> "$profilefile"
echo "### The section above added by aws-setup.sh" >> "$profilefile"
echo "###" >> "$profilefile"
